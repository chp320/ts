...
[WebSecurityConfig.java](https://github.com/shinsunyoung/springboot-developer/blob/main/chapter8/src/main/java/me/shinsunyoung/springbootdeveloper/config/WebSecurityConfig.java){: target="_blank"}
